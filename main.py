...
unit = ColumnTransformer(
    [
        ('normalize',scaler.fit_transform(features[:,[0,3,5]],features[:,[0,3,5]])),
        ('lebel_encoder_sex',lebel_encoder_sex.fit_transform(features[:,1]),features[:,1])
        ('lebel_encoder_cp',)
        'onehotencoder', ondehotenconder_heart
    ]
)
